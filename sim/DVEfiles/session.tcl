...
gui_load_child_values {sh_reg_test}
...
gui_sg_addsignal -group "$_session_group_1" { sh_reg_test.rd_data sh_reg_test.clk sh_reg_test.reset sh_reg_test.wr_en sh_reg_test.wr_data sh_reg_test.re_en sh_reg_test.re_data }
...
catch {gui_list_select -id ${Hier.1} {sh_reg_test}}
...
gui_list_show_data -id ${Data.1} {sh_reg_test}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {sh_reg_test.rd_data sh_reg_test.clk sh_reg_test.reset sh_reg_test.wr_en sh_reg_test.wr_data sh_reg_test.re_en sh_reg_test.re_data }}
